...
export default function GameInput({setSelectedCellColor, checkGuess, undo}:Props){
    ...
    return (
        <div className="w-full aspect-square grid gap-2 grid-cols-4 scale-[calc(1/1.4142)] -mt-28 -rotate-45 translate-y-[8%]">
            ...
            <div className="aspect-square bg-slate-600 rounded-sm  transition-all p-2 hover:shadow-xl hover:scale-105 hover:bg-slate-500" onClick={undo}>
                <svg className="rotate-45" fill="#aaaaaa" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="-51.2 -51.2 614.40 614.40" enable-background="new 0 0 512 512">
            ...
            <div className="aspect-square bg-transparent"></div>
            <div className="aspect-square bg-slate-600 rounded-sm  transition-all hover:shadow-xl hover:scale-105 hover:bg-slate-500" onClick={checkGuess}>
