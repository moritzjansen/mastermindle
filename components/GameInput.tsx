...
export default function GameInput({setSelectedCellColor, checkGuess, undo}:Props){
    return (
        <div className="w-full aspect-square grid gap-2 grid-cols-4 scale-[calc(1/1.4142)] -mt-32 -rotate-45 translate-y-[8%]">
            ...
            <div className="aspect-square bg-slate-600 rounded-sm  transition-all p-2 hover-hover:hover:shadow-xl hover-hover:hover:scale-105 hover-hover:hover:bg-slate-500" onClick={undo}>
            ...
            <div className="aspect-square bg-transparent"></div>
            <div className="aspect-square bg-slate-600 rounded-sm  transition-all hover-hover:hover:shadow-xl hover-hover:hover:scale-105 hover-hover:hover:bg-slate-500" onClick={checkGuess}>
